import os, time, configparser, logging, subprocess, re;from logging.handlers import TimedRotatingFileHandler
class StressTesting:
    ...
    def setup_logging(self):
        ...
        handler = TimedRotatingFileHandler(log_filename, when="midnight", interval=1)  # 定时轮转日志
    ...
    def run(self):
        ...
        loop_count = 1
        logging.info(f'{section_name}计划开始了！')
        while True:
